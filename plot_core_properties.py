...
def plot_core_trajectory(core_fname_pattern, steps):
    ...
    for core_tag, core_mass in zip(core_tags, core_masses):
        ...
        fig.suptitle('TreeNodeMass={:.2e}'.format(core_mass))
        axs[0][0].plot(x-x[-1], y-y[-1], '-o', label='Path')
        axs[0][0].plot(x[-1]-x[-1], y[-1]-y[-1], 'o', ms=20, mfc='none', label='Last Pos')
        axs[0][0].legend(framealpha=0.0)
        axs[0][0].axis('equal')
        axs[0][0].set_xlabel('x')
        axs[0][0].set_ylabel('y')
        
        axs[0][1].plot(z-z[-1], y-y[-1], '-o', label='Path')
        ...
        axs[1][1].plot(step, radius*1000.0, '-o')
        ...
        plt.show()
        # dtk.save_figs('figs/'+__file__+'/individual_cores_massive_satellite/')
        plt.close()
...
if __name__ == "__main__":
    steps=[499, 487, 475, 464, 453, 442, 432, 421, 411, 401, 392, 382, 373, 365, 355, 347, 338, 331, 323, 315, 307, 300, 293, 286, 279, 272, 266, 259, 253, 247, 241, 235, 230, 224, 219, 213, 208, 203, 198, 194, 189, 184, 180, 176, 171, 163, 159, 155, 151, 148, 144, 141, 137, 134, 131, 127, 124, 121, 119, 116, 113, 110, 107, 105, 102, 100]
    ...
    core_fname_pattern = '/data/a/cpac/dkorytov/data/AlphaQ/core_catalog9_updated_centrals/$step$.coreproperties'
