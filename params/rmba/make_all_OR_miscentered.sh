...
for mstar in "${mstars[@]}"; do
	...
	for model_i in 0 1 2 3; do 
		...
		if [ $make_param = true ]; then
		    ...
		    ## miscentering options
		    echo "miscentering_distribution /home/dkorytov/proj/Ngal_sdss/data/Pr_center/distribution.hdf5" >> $param_fname
		    sed -i "s/force_central_as_galaxy false/force_central_as_galaxy true/g" $param_fname
