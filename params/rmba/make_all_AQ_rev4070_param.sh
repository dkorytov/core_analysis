...
cluster_locs=("tmp_hdf5/clusters_AQ_M200m.rev4070.hdf5" "tmp_hdf5/clusters_AQ_M200c.rev4070.hdf5")
...
for mstar in "${mstars[@]}"; do
	...
	for model_i in 0 1 2 3; do 
		...
		prefix='AQ'
		core_cat='rev4070/'
		param_fname="params/rmba/simet/${core_cat}${cluster_types[$cluster_i]}/mstar${mstar}/${cost_types[$cost_i]}${prefix}_${model_types[$model_i]}.param"
		dir=${param_fname%/*}
