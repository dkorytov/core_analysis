...
zmrh5_locs=("/home/dkorytov/phys/Ngal_sdss/data/rad_profile_mstar@mstarval@_wmap7_spider_mean_bcg/result/type1_weight1_mag1_clr1_result.hdf5" "/home/dkorytov/phys/Ngal_sdss/data/rad_profile_mstar@mstarval@_wmap7_spider_crit_bcg/result/type1_weight1_mag1_clr1_result.hdf5")
...
for mstar in "${mstars[@]}"; do
	...
	for model_i in 0 1 2 3; do 
	    for cost_i in 0; do
		param_fname="params/cfn/spider/mstar${mstar}/${cluster_types[$cluster_i]}/${cost_types[$cost_i]}spider_${model_types[$model_i]}.param"
