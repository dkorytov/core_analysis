...
template_fname="params/templates/template.mstar-1.qc.param"

for cluster_i in 0 1;do
    for model_i in 0 1 2; do 
	for cost_i in 0;   do
	    param_fname="params/cfn/simet/mstar-1/${cluster_types[$cluster_i]}/${cost_types[$cost_i]}qc_${model_types[$model_i]}.param"
